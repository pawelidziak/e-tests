...
export const LANG_PL_TRANS = {
  ...
  'feature-create-header': 'Twórz nowe testy',
  'feature-create-paragraph': 'W prosty i szybki sposób stwórz swój własny test',
  'feature-search-header': 'Wyszukuj testy',
  'feature-search-paragraph': 'Sprawdzaj testy stworzone przez innych użytkowników i przekonaj się czy je rozwiążesz',
  'feature-config-header': 'Dostosuj test',
  'feature-config-paragraph': 'Wybierz wygodne dla Ciebie ustawienia uczenia się',
  'feature-import-header': 'Importuj / eksportuj',
  'feature-import-paragraph': 'Skorzystaj z funkcji importu oraz eksportu by w szybki wczytać lub pobrać zadania',
  'feature-started-header': 'Przeglądaj swój postęp',
  ...
  // TEST NAME FORM
  'test-name-label': 'Nazwa testu',
  'test-name-placeholder': 'Nazwa testu...',
  'test-name-hint': 'Rozpoznawalne nazwy są najlepsze!',
  'test-name-error': 'Nazwa testu jest wymagana',

  // TEST TAGS FORM
  'test-tags-label': 'Tagi',
  'test-tags-placeholder': 'Nowy tag...',
  'test-tags-hint': 'Oddziel przez <strong>ENTER</strong> lub <strong>PRZECINEK</strong>',
  'test-tags-error': 'Wybierz co najmniej <strong>1</strong> tag',

  // TEST DESC FORM
  'test-desc-label': 'Opis',
  'test-desc-placeholder': 'Opis testu...',

  // TEST CREATE FORM
  'test-create-label': 'Data utworzenia',

  // TEST VISIBILITY FORM
  'test-visibility-public': 'Publiczny',
  'test-visibility-private': 'Prywatny',
  'test-visibility-tooltip': 'Opcja Prywatny nie jest jeszcze dostępna',
  ...
  // TEST-BOXES
  'test-boxes-placeholder': 'Wyszukaj zestaw',

  // TESTS-TABLE
  'tests-table-placeholder': 'Wyszukaj zestaw',
  'tests-table-rate': 'Ocena',
  ...
  // DISPLAY TESTS FORM GENERAL
  'no-results': 'Brak wyników',
  'create-test': 'Stwórz test',
  'go-to-search': 'Wyszukaj test',
  'clear-input': 'Wyczyść',
  'no-desc': 'Brak opisu',

  // TABLE PAGINATOR
  'table-items-per-page': 'Pozycji na stronie:',
  'next-page-label': 'Następna strona',
  ...
  'app-download-win-store': 'Sklep Windows',
  'app-download-win-launch': 'Windows - wersja uruchamialna',
  ...
  'app-download-mac-linux-instruction': 'Dla systemów MacOS / Linux możesz pobrać wersję uruchamianą aplikacji <strong>eTesto</strong>',
  'app-download-mobile': 'Mobile',
  'app-download-mobile-instruction-one': '1. Aby korzystać z <strong>eTesto</strong> na urządzeniu mobilnym, takim jak smartfon lub tablet, wystarczy otworzyć aplikację <a href="https://www.etesto.eu">eTesto</a> w przeglądarce na Twoim urządzeniu.',
